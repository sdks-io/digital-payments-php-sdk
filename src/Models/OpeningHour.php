...
class OpeningHour implements \JsonSerializable
{
    ...
    /**
     * Converts the OpeningHour object to a human-readable string representation.
     *
     * @return string The string representation of the OpeningHour object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'OpeningHour',
            [
                'closingFromHours' => $this->closingFromHours,
                'closingFromMinutes' => $this->closingFromMinutes,
                'closingToHours' => $this->closingToHours,
                'closingToMinutes' => $this->closingToMinutes,
                'fromDay' => $this->fromDay,
                'openingFromHours' => $this->openingFromHours,
                'openingFromMinutes' => $this->openingFromMinutes,
                'openingToHours' => $this->openingToHours,
                'openingToMinutes' => $this->openingToMinutes,
                'toDay' => $this->toDay
            ]
        );
    }
