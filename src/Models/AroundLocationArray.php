 ...
 *
 * Error Codes
 * All request will return a 200 HTTP Response, but the Response will include details of an error
 * if/when an error occurs
 */
class AroundLocationArray implements \JsonSerializable
{
    /**
     * @var Datum[]
     */
    ...
    /**
     * Converts the AroundLocationArray object to a human-readable string representation.
     *
     * @return string The string representation of the AroundLocationArray object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify('AroundLocationArray', ['data' => $this->data]);
    }
