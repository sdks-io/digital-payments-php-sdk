...
class MobilePaymentRegistrationRequest implements \JsonSerializable
{
    ...
    /**
     * Converts the MobilePaymentRegistrationRequest object to a human-readable string representation.
     *
     * @return string The string representation of the MobilePaymentRegistrationRequest object.
     */
