...
class PrepareFuelingResponse implements \JsonSerializable
{
    ...
    /**
     * Converts the PrepareFuelingResponse object to a human-readable string representation.
     *
     * @return string The string representation of the PrepareFuelingResponse object.
     */
    public function __toString(): string
    {
        return ApiHelper::stringify(
            'PrepareFuelingResponse',
            ['mppTransactionId' => $this->mppTransactionId, 'products' => $this->products]
        );
    }
