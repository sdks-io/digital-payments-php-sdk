...
class ShellSmartPayAPIClientBuilder
{
    /**
     * @var array
     */
    ...
    public function mppTokenCredentials(MppTokenCredentialsBuilder $mppToken): self
    {
        $this->config = array_merge($this->config, $mppToken->getConfiguration());
        return $this;
    }

    public function oAuthTokenPostCredentials(OAuthTokenPostCredentialsBuilder $oAuthTokenPost): self
    {
        $this->config = array_merge($this->config, $oAuthTokenPost->getConfiguration());
        return $this;
    }
    ...
    public function build(): ShellSmartPayAPIClient
    {
        return new ShellSmartPayAPIClient($this->config);
    }
}
