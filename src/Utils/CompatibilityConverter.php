...
namespace ShellSmartPayAPILib\Utils;
...
use ShellSmartPayAPILib\Http\HttpContext;
use ShellSmartPayAPILib\Http\HttpRequest;
use ShellSmartPayAPILib\Http\HttpResponse;
