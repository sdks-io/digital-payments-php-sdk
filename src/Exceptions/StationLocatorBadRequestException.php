...
class StationLocatorBadRequestException extends ApiException
{
    /**
     * @var string|null
     */
    ...
    /**
     * Converts the StationLocatorBadRequestException object to a human-readable string representation.
     *
     * @return string The string representation of the StationLocatorBadRequestException object.
     */
