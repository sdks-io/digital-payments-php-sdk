...
class StationLocatorUnauthorizedException extends ApiException
{
    ...
    /**
     * Converts the StationLocatorUnauthorizedException object to a human-readable string representation.
     *
     * @return string The string representation of the StationLocatorUnauthorizedException object.
     */
