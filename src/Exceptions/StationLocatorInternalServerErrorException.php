...
class StationLocatorInternalServerErrorException extends ApiException
{
    ...
    /**
     * Converts the StationLocatorInternalServerErrorException object to a human-readable string
     * representation.
     *
     * @return string The string representation of the StationLocatorInternalServerErrorException object.
     */
